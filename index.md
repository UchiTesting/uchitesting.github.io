...
Some other notes shall be hosted with these GitHub Pages. This is especially true when they are not linked to any repository. I shall port other notes in there bit by bit. See the [index of available local notes](<LocalNotes.html>).
